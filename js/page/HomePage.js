/*
 * @Author: zhaojiawei 
 * @Date: 2018-12-12 10:01:51 
 * @Last Modified by: zhaojiawei
 * @Last Modified time: 2018-12-18 15:34:12
 */
/**
 * 首页
 * @flow
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                >
                    {this._renderTab(PopularPage, FLAG_TAB.flag_popularTab, '热门', require('../../res/images/ic_polular.png'))}
