...
// 添加标签
    saveKey() {
        ...
        if (this.checkKeyIsExist(this.keys, key)) {
            this.refs.toast.show(this.state.inputKey + ' 已经保存 ', DURATION.LENGTH_SHORT)
        } else {
            key = {
                "path": key,
                "name": key,
            ...
            this.refs.toast.show(this.state.inputKey + ' 保存成功 ', DURATION.LENGTH_SHORT);
        ...
        let bottomButton = this.state.showBottomButton ?
            ...
            >
                <View style={{justifyContent: 'center',}}>
                    <Text style={styles.title}>添加标签 {this.state.inputKey} </Text>
                </View>
            </TouchableOpacity>
            : null;
        return (
