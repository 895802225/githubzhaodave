/*
 * @Author: zhaojiawei 
 * @Date: 2018-12-12 10:01:45 
 * @Last Modified by: zhaojiawei
 * @Last Modified time: 2018-12-25 14:44:51
 */
/**
 * FavoritePage
 * @flow
        ...
        let content =
            <ScrollableTabView
                ...
                renderTabBar={() => <ScrollableTabBar style={{height: 40,borderWidth:0,elevation:2}} tabStyle={{height: 39}}
                                                      underlineHeight={2}/>}
            >
                <FavoriteTab {...this.props} tabLabel='热门' flag={FLAG_STORAGE.flag_popular} theme={this.state.theme}/>
                <FavoriteTab {...this.props} tabLabel='趋势' flag={FLAG_STORAGE.flag_trending} theme={this.state.theme}/>
            </ScrollableTabView>
        let navigationBar =
            <NavigationBar
